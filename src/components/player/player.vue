  ...
  <div class="player" v-show="playlist.length > 0">
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          <div class="back" @click="back">
            <font-awesome-icon icon="chevron-down" class="icon-back"/>
          </div>
        ...
        <div class="bottom">
          ...
          <div class="operators">
            <div class="icon i-left">
              <font-awesome-icon :icon="iconMode" class="icon-sequence" @click="changeMode"/>
            </div>
            <div class="icon i-left" :class="disableCls">
              <font-awesome-icon icon="backward" class="icon-prev" @click="prev"/>
            </div>
            <div class="icon i-center" :class="disableCls">
              <font-awesome-icon @click="togglePlaying" :icon="playIcon" class="icon-play"/>
            </div>
            <div class="icon i-right" :class="disableCls">
              <font-awesome-icon icon="forward" class="icon-next" @click="next"/>
            </div>
            <div class="icon i-right">
              <font-awesome-icon icon="heart" class="icon-not-favorite"/>
            </div>
          </div>
        </div>
      </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
          <font-awesome-icon icon="chevron-up" class="icon-playlist"/>
        </div>
      </div>
    </transition>
