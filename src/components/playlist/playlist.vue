    ...
    <div class="playlist" @click="hide" v-show="showFlag">
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            <font-awesome-icon :icon="iconMode" class="icon" @click="changeMode"></font-awesome-icon>
            <span class="text">{{modeText}}</span>
            <span class="clear" @click="showConfirm">
              <font-awesome-icon class="icon-clear" icon="trash"></font-awesome-icon>
            </span>
          </h1>
        </div>
        <scroll class="list-content" ref="listContent" :refreshDelay="refreshDelay">
          <transition-group ref="list" name="list" tag="ul">
            <li class="item" :key="item.id" v-for="(item,index) in sequenceList" @click="selectItem(item,index)">
              <font-awesome-icon class="current" :icon="['far','play-circle']"
        ...
        <div class="list-operate">
          <div @click="addSong" class="add">
            <font-awesome-icon class="icon-add" icon="plus"></font-awesome-icon>
